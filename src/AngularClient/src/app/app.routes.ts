...
export const routes: Routes = [
  ...
  {path: 'artist', title: 'Artists', loadChildren: () => import('./resources/artist/artist.routes').then(mod => mod.ARTIST_ROUTES)},
  {path: 'album', title: 'Albums', loadChildren: () => import('./resources/album/album.routes').then(mod => mod.ALBUM_ROUTES)},
